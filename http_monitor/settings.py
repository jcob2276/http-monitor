...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'monitor' / 'templates'],  # Używamy BASE_DIR zamiast hardcodowanej ścieżki
        'APP_DIRS': True,  # Django będzie szukać szablonów w folderze 'templates' w aplikacjach
        'OPTIONS': {
            'context_processors': [
